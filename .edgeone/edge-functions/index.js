  ...
  var DEFAULT_API_URL = "https://api.deepseek.com/v1";
  var FALLBACK_KEY = "sk-106c3e5691ff4c088d87bd5dec1445ea";
    ...
    try {
      ...
      return json({ error: "\u4EE3\u7406\u8BF7\u6C42\u4E0A\u6E38\u5931\u8D25\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5" }, 502);
        ...
        const middlewareResponse = await runMiddleware({
          ...
          env: {"ProjectId":"makers-5ia8vzkvcwpy","NG_CLI_ANALYTICS":"false","NUXT_TELEMETRY_DISABLED":"1","COREPACK_ENABLE_DOWNLOAD_PROMPT":"0","COREPACK_ENABLE_STRICT":"0","YARN_ENABLE_INTERACTIVE":"0","NPM_CONFIG_YES":"true","CI":"true","TMPDIR":"/var/folders/y5/0nzcbgzd5q90d50336tpyc9m0000gn/T/","EDGEONE_PROJECT_ID":"makers-5ia8vzkvcwpy","PAGES_PROJECT_ID":"makers-5ia8vzkvcwpy"},
          waitUntil,
          hookCtx
        });
        ...
        if (middlewareResponse) {
          ...
          const edgeFunctionResponse = await pagesFunctionResponse({request, params, env: {"ProjectId":"makers-5ia8vzkvcwpy","NG_CLI_ANALYTICS":"false","NUXT_TELEMETRY_DISABLED":"1","COREPACK_ENABLE_DOWNLOAD_PROMPT":"0","COREPACK_ENABLE_STRICT":"0","YARN_ENABLE_INTERACTIVE":"0","NPM_CONFIG_YES":"true","CI":"true","TMPDIR":"/var/folders/y5/0nzcbgzd5q90d50336tpyc9m0000gn/T/","EDGEONE_PROJECT_ID":"makers-5ia8vzkvcwpy","PAGES_PROJECT_ID":"makers-5ia8vzkvcwpy"}, waitUntil, eo });
        ...
        })({request: ev.request, params: {}, env: {"ProjectId":"makers-5ia8vzkvcwpy","NG_CLI_ANALYTICS":"false","NUXT_TELEMETRY_DISABLED":"1","COREPACK_ENABLE_DOWNLOAD_PROMPT":"0","COREPACK_ENABLE_STRICT":"0","YARN_ENABLE_INTERACTIVE":"0","NPM_CONFIG_YES":"true","CI":"true","TMPDIR":"/var/folders/y5/0nzcbgzd5q90d50336tpyc9m0000gn/T/","EDGEONE_PROJECT_ID":"makers-5ia8vzkvcwpy","PAGES_PROJECT_ID":"makers-5ia8vzkvcwpy"}, waitUntil: ev.waitUntil.bind(ev) });
        // ↑ 用户原始代码结束
      }
